# Generated by Django 5.1.3 on 2024-11-08 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stato_prenotazione', models.CharField(choices=[('PR', 'Prenotata'), ('SC', 'Scaduta'), ('CA', 'Cancellata'), ('PG', 'Pagata'), ('IC', 'In Corso')], default='PR', max_length=2)),
