...
class CalendarioPrenotazioneAdmin(admin.ModelAdmin):
    list_display = ['prenotazione', 'data_inizio', 'data_fine', 'prenotazione__data_prenotazione']
...
class PrenotazioneAdmin(admin.ModelAdmin):
    list_display = ['visitatore', 'stato_prenotazione', 'data_prenotazione', 'camera']
    search_fields = ['richiesta', ]
    list_filter = ['visitatore', 'camera', 'camera__proprieta', 'stato_prenotazione']
